...
public class ElasticsearchUtil {
    ...
    // 创建映射
    public static void createMapping(String index,String indexType,String json) throws Exception{
        // 配置映射关系
//        Map<String,Object> mappings = new HashMap<>();
//
//        Map<String,Object> type = new HashMap<>();
//        mappings.put(indexType, type);
...
//        System.out.println(json);
        ...
        PutMappingRequest request = Requests.putMappingRequest(index).type(indexType).source(json,XContentType.JSON);
...
// 解析对象
     ...
     * @return
     */
    public static List<Map<String, Object>> searchListData(String index, String type, QueryBuilder query, Integer size, String fields, String sortField,String sortOrder, String highlightField) {
